...
| Microsoft/GitHub | [GitHub Spec Kit](https://github.github.com/spec-kit/) | Durable, structured specifications support the current handoff from frozen intent to Spec & Design and Execution. |
...
| AWS | [Agent governance: AWS Well-Architected Agentic AI Lens](https://docs.aws.amazon.com/wellarchitected/latest/agentic-ai-lens/agentsus03.html) | Lifecycle ownership, deployment controls, telemetry, and feedback loops inform controls when they are intentionally introduced. |
